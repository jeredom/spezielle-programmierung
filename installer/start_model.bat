@ECHO OFF
TITLE Reissverschlussverfahren
...
CD Reissverschlussverfahren

REM Start the Model
START javaw -Xss10M -Xmx400M -cp %CP% repast.simphony.runtime.RepastMain ./Reissverschlussverfahren.rs
